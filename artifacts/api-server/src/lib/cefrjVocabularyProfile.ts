...
const CEFRJ_LEXICON: Record<string, CefrJLevel> = {
  // A1 core verbs that should be considered known by Grade 3 readers.
  go: "A1_1",
  ask: "A1_1",
  move: "A1_2",
  walk: "A1_1",
  ...
  early: "A1_2",
  late: "A1_2",
  // High-frequency function words occasionally seen after token cleanup.
  thing: "A1_1",
  people: "A1_2",
  child: "A1_2",
  children: "A1_2",
